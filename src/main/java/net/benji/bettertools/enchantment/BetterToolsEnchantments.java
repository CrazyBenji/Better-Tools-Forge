...
public class BetterToolsEnchantments {
    ...
    public static final RegistryObject<Enchantment> REAPING = ENCHANTMENTS.register("reaping", () -> new ReapingEnchantment(Enchantment.Rarity.VERY_RARE, SCYTHES, EquipmentSlot.MAINHAND));
