...
public class LumberAxeItem extends AxeItem {
    ...
    public LumberAxeItem(ToolMaterial toolMaterial, Properties properties, int maxLogs) {
        this(toolMaterial, 6.0f, -3.2f, properties, maxLogs);
    }
    ...
    public boolean mineBlock(@NotNull ItemStack stack, @NotNull Level level, @NotNull BlockState state, @NotNull BlockPos pos, @NotNull LivingEntity player) {
        ...
        if (level instanceof ServerLevel server && state.is(BlockTags.LOGS)) {
